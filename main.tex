...
\begin{table}[h!]
	\centering\begin{tabular}{c|cc}
		...
		$Fe^P{3+}$&Ion Hierro (3+)&Ion Hierro (III)\\
		$Au^P{+}$&Ion Oro (1+)&Ion Oro (I)\\
		$B^P{3+}$&Ion Boro (3+)&Ion Boro)\\
		$Mg^P{2+}$&Ion Magnesio (2+)&Ion Magnesio \\ \hline
	\end{tabular}
\end{table}
